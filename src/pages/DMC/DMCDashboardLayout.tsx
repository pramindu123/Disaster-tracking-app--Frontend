  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row font-sans bg-gradient-to-br from-blue-50 via-white to-purple-50">
      ...
      >
        <div>
          {/* App Name */}
          <div className="text-4xl font-extrabold text-left mb-6" style={{
          ...
          <div className="flex flex-col items-center mb-6">
            ...
            <div className="text-center text-sm text-gray-700 mt-2">
              ...
              <div className="text-xs text-gray-500">NIC number</div>
          ...
          <nav className="flex flex-col gap-2 items-start w-full">
            ...
            <NavLink to="/dmc-dashboard/alerts" className="bg-white py-2 px-6 rounded-full text-left w-full hover:bg-blue-100">Alerts</NavLink>
            <NavLink to="/dmc-dashboard/reports" className="bg-white py-2 px-6 rounded-full text-left w-full hover:bg-blue-100">Reports</NavLink>
            <NavLink to="/dmc-dashboard/aid-requests" className="bg-white py-2 px-6 rounded-full text-left w-full hover:bg-blue-100">Aid Requests</NavLink>
            <NavLink to="/dmc-dashboard/volunteers" className="bg-white py-2 px-6 rounded-full text-left w-full hover:bg-blue-100">Volunteers</NavLink>
            <NavLink to="/dmc-dashboard/settings" className="bg-white py-2 px-6 rounded-full text-left w-full hover:bg-blue-100 mt-2">System Settings</NavLink>
            <button
